			...
			<main className="flex-grow">
				...
				<section className="relative h-screen flex items-center justify-center overflow-hidden">
					...
					<div className="relative container mx-auto px-4 text-center text-white z-10">
						<h1 className="text-5xl md:text-7xl font-light mb-6 tracking-wide">
							<span className="block font-sans text-6xl md:text-9xl font-thin pb-2">
								your new space.
							</span>
							<TypeAnimation
								sequence={["anytime.", 2000, "anywhere.", 2000, "now.", 2000]}
								wrapper="span"
								speed={30}
						...
						<p className="text-xl mb-8 max-w-2xl mx-auto font-light opacity-70">
							Come find your new vibrant workspace. Whether you're a digital
							nomad, startup, or company - we've got your perfect spot! (now.)
						</p>
						<div className="max-w-md mx-auto">
							<form className="flex flex-col sm:flex-row gap-2">
								...
								<Button
									type="submit"
									className="bg-blue-400 text-white hover:bg-blue-600 font-thin font-mono"
								>
									Join Waitlist
				...
				<section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-black to-zinc-900 py-16">
					<div className="container mx-auto px-4">
						<div className="text-6xl text-left mb-2 text-white font-sans font-extralight">
							What do our spaces offer?
						</div>
						<div className="text-xl text-left mb-20 text-white/70 font-sans font-extralight">
						...
						<div className="flex flex-col md:flex-row gap-12 max-w-7xl mx-auto">
							...
							<div className="md:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-8">
								...
								<FeatureCard
									icon={
										<Calendar className="h-16 w-16 text-blue-400 stroke-1" />
									}
					...
					<div className="container mx-auto px-4">
						<div className="flex flex-col md:flex-row items-stretch justify-between">
							<div className="md:w-1/2 mb-12 md:mb-0 flex flex-col justify-center">
								<h2 className="text-4xl md:text-6xl mb-8 font-sans font-extralight">
									Ready for an{" "}
								...
								<p className="text-xl mb-12 max-w-md font-mono font-light">
									Walk in, sit down, and start collaborating. No setup required.
								</p>
							</div>

							<div className="hidden md:block w-px bg-gradient-to-b from-transparent via-gray-400 to-transparent" />

							<div className="md:w-1/2 space-y-16 md:pl-8">
								<div>
									<h3
										className="text-5xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600 mb-2 font-light"
										style={{ lineHeight: "1.2" }}
									>
										Seamless
									</h3>
									<p className="text-xl text-gray-300 font-sans font-extralight">
										Book a room and start your meeting within minutes.
									</p>
								</div>
								<div>
									<h3
										className="text-5xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500 mb-2	font-light"
										style={{ lineHeight: "1.2" }}
									>
										{" "}
									...
									<p className="text-xl text-gray-300 font-sans font-light">
										State-of-the-art video conferencing at your fingertips.
									</p>
								</div>
								<div>
									<h3
										className="text-5xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-yellow-500 mb-2 font-light"
										style={{ lineHeight: "1.2" }}
									>
										Energized
									</h3>
									<p className="text-xl text-gray-300 font-sans font-light">
										Complimentary coffee and snacks to fuel your ideas.
									</p>
								</div>
							</div>
						</div>
...
function FeatureCard({
	...
	return (
		<div className="p-10 text-center flex items-center justify-center border border-white/10 rounded-xl relative">
			<div className="absolute left-4 bottom-3 opacity-10 text-6xl">{icon}</div>
			<div className="flex flex-col items-center justify-center z-10">
				<div className="text-2xl mb-6 text-white font-sans font-extralight">
					{title}
				</div>
				<div className="text-gray-300 text-lg font-sans font-extralight">
					{description}
				</div>
			</div>
		</div>
